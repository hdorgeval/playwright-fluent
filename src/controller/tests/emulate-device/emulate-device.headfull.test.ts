...
describe('Playwright Controller - emulateDevice', (): void => {
  ...
  test('should target firefox in headfull mode with simulated device', async (): Promise<void> => {
    // Given
  ...
  test('should target webkit in headfull mode with simulated device', async (): Promise<void> => {
    // Given
