...
describe('Playwright Fluent - expectThat hasFocus', (): void => {
  ...
  test('should wait until selector object exists and has focus - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-has-focus.test.html')}`;
  ...
  test('should give back an error when selector does not have focus - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-has-focus.test.html')}`;
  ...
  test('should give back an error when selector object does not have focus - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-has-focus.test.html')}`;
