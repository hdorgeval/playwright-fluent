...
describe('Playwright Fluent - withViewPort', (): void => {
  ...
  test('should target firefox in headless mode with viewport size 800x600', async (): Promise<void> => {
    // Given
  ...
  test('should target firefox in headless mode with viewport size 1920x1440', async (): Promise<void> => {
    // Given
    const browser = 'firefox';
    const options: LaunchOptions = {
      headless: true,
