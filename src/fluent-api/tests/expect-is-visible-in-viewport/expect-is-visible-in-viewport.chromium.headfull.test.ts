...
describe('Playwright Fluent - expectThat isVisible in viewport', (): void => {
  ...
  test('should wait until selector exists and is visible in the viweport - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-is-visible-in-viewport.test.html')}`;
    ...
    // Then
    const isVisible = await p.isVisibleInViewport(selector, noWaitNoThrowOptions);
  ...
  test('should give back an error when selector object is hidden - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-is-visible-in-viewport.test.html')}`;
  ...
  test('should give back an error when selector is out of the viewport - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-is-visible-in-viewport.test.html')}`;
  ...
  test('should give back an error when selector object is out of the viewport - chromium', async (): Promise<void> => {
    // Given
    const url = `file:${path.join(__dirname, 'expect-is-visible-in-viewport.test.html')}`;
